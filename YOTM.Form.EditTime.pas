...
uses
  ...
  YOTM.Form.ModalEdit, Vcl.ComCtrls, Vcl.StdCtrls, Vcl.ExtCtrls, HGM.Button,
  HGM.Controls.PanelExt, System.Types, Vcl.Grids, HGM.Controls.VirtualTable,
  HGM.Popup;
...
type
  TFormEditTime = class(TFormModalEdit)
    ...
    procedure TableExTasksItemClick(Sender: TObject; MouseButton: TMouseButton; const Index: Integer);
...
begin
  ...
  case FCol of
    0:
      Value := FormMain.TaskItems[FRow].Name;
  end;
end;

procedure TFormEditTime.TableExTasksItemClick(Sender: TObject; MouseButton: TMouseButton; const Index: Integer);
begin
  FPopup.Close;
